...
## Bước 3. Sau khi kết nối SSH sẽ mở màn hình Terminal
...
=> Chọn y để cập nhật version
...
- Bật thiết lập redirect HTTP sang HTTPS
![anhkevin_sll_bitnami_4.PNG]({{ "/assets/img/uploads/2021/anhkevin_sll_bitnami_4.PNG" | relative_url }})

- Nó liệt kê danh sách quá trình cài đặt
=> Đồng ý "nhập Y" để bắt đầu
